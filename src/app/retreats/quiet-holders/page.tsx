...
export const metadata: Metadata = {
  ...
  description:
    'Sacred ceremony, grief circles, and healing for women honouring pregnancy loss, miscarriage, and the babies held only in their hearts. Yarra Valley, Melbourne.',
}

export default function QuietHoldersRetreatPage() {
  return (
    <>
      {/* ─── HERO ─── */}
        ...
        <div className="max-w-5xl mx-auto relative">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              {
                title: 'Release',
                desc: 'Through breathwork, gentle movement, and Havening, we work with the body. Grief lives there. The body needs ceremony just as much as the heart does.',
              },
              {
                title: 'Become',
            ...
            {[
              {
                ...
                desc: 'A morning or afternoon held in sacred space. Guided ceremony, grief circle, oracle cards, and a closing ritual. Intimate and small, up to 8 women.',
